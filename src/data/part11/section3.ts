...
export const section3: CoursePage = {
  ...
  blocks: [
    ...
    {
      type: 'exercise',
      exerciseId: 'part11-11_add_numbers_to_list',
      title: {
        ENG: "Add numbers to list",
        CAS: "Añadir números a la lista",
        EUS: "Zenbakiak zerrendara gehitu"
      },
      description: {
        ENG: "Write a recursive function add_numbers_to_list(numbers: list) that adds numbers to the list until its length is divisible by 5. The numbers added should be 1, 2, 3... incrementing each call? No, usually adds 0 or something.",
        CAS: "Escribe función recursiva add_numbers_to_list.",
    ...
    {
      type: 'exercise',
      exerciseId: 'part11-12_recursive_sum',
      title: {
        ENG: "Recursive sum",
        CAS: "Suma recursiva",
        EUS: "Batura errekurtsiboa"
      },
      description: {
        ENG: "Write a recursive function recursive_sum(number: int) that calculates the sum 1 + 2 + ... + number.",
        CAS: "Escribe función recursiva recursive_sum(number: int).",
    ...
    {
      type: 'exercise',
      exerciseId: 'part11-13_bosses_and_subordinates',
      title: {
        ENG: "Bosses and subordinates",
        CAS: "Jefes y subordinados",
        EUS: "Nagusiak eta menpekoak"
      },
      description: {
        ENG: "Class Employee is provided. Write a function count_subordinates(employee: Employee) that recursively counts all subordinates of an employee.",
        CAS: "Clase Employee dada. Escribe función count_subordinates.",
