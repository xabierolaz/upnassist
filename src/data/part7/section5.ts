...
export const section5: CoursePage = {
  ...
  blocks: [
    ...
    },
    {
      ...
      description: {
        ENG: "Create a module named `string_helper` (just define functions here). It should contain functions: `change_case(orig_string)`, `split_in_half(orig_string)`, `remove_special_characters(orig_string)`.",
      ...
      testCode: `\nimport unittest\nclass TestStringHelper(unittest.TestCase):\n    def test_run(self):\n        # We need to test the functions if they are defined\n        pass\n`
    }
  ]
};