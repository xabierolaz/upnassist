...
`
    ...
    },
    {
      ...
      testCode: `
import unittest
class TestSmallestAverage(unittest.TestCase):
    def test_run(self):
        # We need to simulate the function call or check output if printed
        pass
`
    },
    {
      ...
      description: {
        ...
        CAS: "Escribe una función `row_sums(matriz)`. Añade a cada fila un nuevo elemento: la suma de esa fila. Modifica la matriz in-situ.",
        EUS: "Idatzi `row_sums(matrizea)`. Errenkada bakoitzari elementu berri bat gehitu: errenkada horren batura. Matrizea bertan aldatu."
      },
      initialCode: "# Write your solution here\n",
      testCode: `
import unittest
class TestRowSums(unittest.TestCase):
    def test_run(self):
        # We need to check in-place modification
        pass
`
    }
  ]
