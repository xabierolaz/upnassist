  ...
  blocks: [
    ...
    },
    {
      ...
      description: {
          ...
          CAS: `Por favor, imprime 'Orwell' si el número es exactamente 1984.`,
    ...
    },
    {
      ...
      description: {
          ...
          CAS: `Por favor, escribe un programa que pida un número entero. Si el número es menor que cero, imprime el número multiplicado por -1.`,
    ...
    },
    {
      ...
      description: {
          ...
          CAS: `Por favor, escribe un programa que pida el nombre. Si el nombre es cualquier cosa excepto 'Jerry', pide las porciones e imprime el coste total.`,
    ...
    },
    {
      ...
      description: {
          ...
          CAS: `Por favor, escribe un programa que pida un número entero. El programa debe imprimir la magnitud del número (si es menor que 1000, 100, 10).`,
    ...
    },
    {
      ...
      description: {
          ...
          CAS: `Por favor, escribe un programa que pida dos números y una operación (suma, resta...).`,
    ...
    },
    {
      ...
      description: {
          ...
          CAS: `Por favor, escribe un programa que pida una temperatura en Fahrenheit e imprima su equivalente en Celsius.`,
    ...
    },
    {
      ...
      description: {
          ...
          CAS: `Por favor, escribe un programa que pida el salario por hora, horas trabajadas y día de la semana. Los domingos se paga doble.`,
    ...
    },
    {
      ...
      description: {
          ...
          CAS: `Por favor, arregla el cálculo del bono.`,
    ...
    },
    {
      ...
      description: {
          ...
          CAS: `Por favor, escribe un programa para resolver una ecuación cuadrática de la forma ax²+bx+c.`,
