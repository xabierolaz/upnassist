...
\begin{frame}[fragile]\frametitle{Exercise I Solution}
\begin{lstlisting}
...
\begin{frame}[fragile]\frametitle{Exercise II Solution}
\begin{lstlisting}
class BinaryTreeNode:
    def __init__(self, value):
        ...
...
\begin{frame}[fragile]\frametitle{Exercise III Solution}
\begin{lstlisting}
def get_height(self):
    if self.left is None:
        left_height = 0
...
\begin{frame}[fragile]\frametitle{Exercise IV Solution}
\begin{lstlisting}
...
\begin{frame}[fragile]\frametitle{Exercise V Solution}
\begin{lstlisting}
...
\begin{frame}[fragile]\frametitle{Exercise VI Solution}
\begin{lstlisting}
...
\begin{frame}[fragile]\frametitle{Exercise VII Solution}
\begin{lstlisting}
