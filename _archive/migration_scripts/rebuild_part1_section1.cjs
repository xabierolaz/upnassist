  ...
  "blocks": [
    ...
    },
    {
      ...
      "testCode": [
        ...
        "        self.assertEqual(output.strip(), ':-)', 'Output should be :-) | La salida debería ser :-) | Irteerak :-) izan beharko luke')"
      ].join("\n")
    }
  ]
};

const outputPath = path.join(__dirname, '../src/data/part1/section1.json');
